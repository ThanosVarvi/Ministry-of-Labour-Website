    ...
    <div class="container">
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active" aria-current="page">Εργαζομένοι</li>
        </ol>
      </nav>
    </div>
    ...
    <h2 style="display:none;">ypakp</h2>
      ...
      <div class="card-deck">
        <div class="card bg-light text-left">
          <img class="card-img-top" src="../img/anastoli.jpg" alt="Card image cap">
          <div class="card-body">
            <p class="card-text">Πραγματοποιήστε τη δήλωσή για την Αίτηση Άδειας Ειδικού Σκοπού.</p><br>
            <a href="leave.php" class="btn btn-primary"style="background-color:rgb(0, 100, 255)">Αίτηση Άδειας Ειδικού Σκοπού</a>
          </div>
        </div>
        <div class="card bg-light text-left">
          <img class="card-img-top" src="../img/empl.jpg" alt="Card image cap2">
          <div class="card-body">
            <p class="card-text">Μάθετε περισσότερες Πληροφορίες για τους Εργαζομένους.</p><br>
            <a href="worker.php" class="btn btn-primary"style="background-color:rgb(0, 100, 255)">Πληροφορίες Εργαζομένων</a>
          </div>
        </div>
      </div>

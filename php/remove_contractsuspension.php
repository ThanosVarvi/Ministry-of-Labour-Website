...
<html lang="en">
  ...
  <head>
   ...
   <head>
   <title>Άρση Αναστολής Σύμβασης</title>
 <meta charset="utf-8">
	...
	<link rel="stylesheet" href="../css/remove_contractsuspension.css">
    ...
    <div class="container">
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active" aria-current="page">Άρση Αναστολής Εργασίας</li>
        </ol>
      </nav>
    </div>
        ...
        <form class="signupform" action="remove_suspension.php" method="post" novalidate>
          <div class="container rem_contract" id="cont_rem_contract">
		  <h1>Άρση Αναστολής Εργασίας</h1>

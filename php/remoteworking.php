...
<html lang="en">
  ...
  <head>
    <title>Δήλωση Εξαποστάσεως Εργασίας</title>
	...
	<link rel="stylesheet" href="../css/remoteworking.css">
...
<body>
  ...
  <header class="main-header clearfix" role="header">
    ...
    <label for="search" style="display: none">σερτσ</label>
...
<!-- Βreadcrumb -->
    <div class="container">
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active" aria-current="page">Δήλωση Εξαποστάσεως Εργασίας</li>
        </ol>
      </nav>
    </div>
        ...
        <form class="signupform" action="insert_remote.php" method="post" novalidate>
          <div class="container remote" id="cont_remote">
		  <h1>Δήλωση Εξ Αποστάσεως Εργασίας</h1>
	...
	?>
		...
		<label for="start_date">Αρχική Ημερομηνία Εξ Αποστάσεως Εργασίας</label><br>
		<input type="text" id="start_date" name="start_date"  class="form-control date-input"  />
		
		<label for="end_date">Καταληκτική Ημερομηνία Εξ Αποστάσεως Εργασίας</label><br>

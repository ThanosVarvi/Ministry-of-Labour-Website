...
<html lang="en">
  ...
  <head>
    <title>Δήλωση Αναστολής Σύμβασης</title>
    <meta charset="utf-8">
	...
	<link rel="stylesheet" href="../css/contractsuspension.css">
...
<!-- Βreadcrumb -->
    <div class="container">
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="./employer.php">Εργοδότες</a></li>
          <li class="breadcrumb-item active" aria-current="page">Δήλωση Αναστολής Σύμβασης</li>
        </ol>
      </nav>
    </div>
        ...
        <form class="signupform" action="insert_suspension.php" method="post" novalidate>
          <div class="container suspension" id="cont_suspension">
		  <h1>Δήλωση Αναστολής Σύμβασης Εργασίας</h1>
    ...
    echo '<label for="dropdown" style="display: none">dropdown</label>
		...
		<?php
		echo '<br><br><b><i>Υποχρεωτικά επιλέξτε την αρχική και καταληκτική ημερομηνία αναστολής.</i></b><br><br>';
	?>
		<label for="start_date">Αρχική Ημερομηνία Αναστολής</label><br>
		<input type="text" id="start_date"  name="start_date" class="form-control date-input"  />
		
		<label for="end_date">Καταληκτική Ημερομηνία Αναστολής</label><br>
		<input type="text" id="end_date"  name="end_date" class="form-control date-input"  />
...
if ($("#company_AFM").length > 0){
 ...
 <script type="text/javascript">
 document.getElementById("start_date").value = new Date().toJSON().slice(0,10).split('-').reverse().join('/')
 document.getElementById("end_date").value = new Date().toJSON().slice(0,10).split('-').reverse().join('/')
